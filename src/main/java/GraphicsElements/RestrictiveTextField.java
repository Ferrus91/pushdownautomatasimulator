...
/*
   Class taken from http://myjavafx.blogspot.co.uk/2013/05/restricting-user-input-on-textfield.html
 */
...
public class RestrictiveTextField extends TextField {
    static Logger logger = Logger.getLogger(RestrictiveTextField.class);
        ...
        textProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observableValue, String s, String s1) {
                ...
                if (restrict.get() != null && !restrict.get().equals("") && !s1.matches(restrict.get() + "*")) {
                    logger.trace("Max length triggered");
                    ignore = true;
                    setText(s);
                    ignore = false;
                }
